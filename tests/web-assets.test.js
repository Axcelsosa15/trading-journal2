...
console.log("canonical/sitemap use the real GitHub Pages URL (no placeholder):", /axcelsosa15\.github\.io\/trading-journal2/.test(idx) && !/bitacora\.pages\.dev/.test(idx));
